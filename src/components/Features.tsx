      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <motion.h2 
            ...
            className="section-title text-center text-black dark:text-white text-4xl font-bold"
          >
            App Features
          </motion.h2>
          <motion.p 
          ...
          >
            Our comprehensive suite of features designed to enhance your pet parenting experience and create lasting memories.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, i) => (
            <motion.div
              ...
              className="feature-card bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300"
            >
              ...
              <motion.div 
                className="mt-6 h-48 rounded-lg overflow-hidden"
